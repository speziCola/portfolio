      ...
      <div className="ck__content">
        ...
        <div className="ck__content__wrapper">
          ...
          <div className="ck__content__wrapper__timestamp">
            <ul className="ck__skill-list">
              ...
              <li>
                <TimeStamp time="02/2015 – 05/2015" title="Herlyn-konsens" type="Webdesign" link="external" url="http://www.herlyn-konsens.de/"
                infos="
              ...
              <li>
                <TimeStamp time="02/2013 – 04/2013" title="Physiologikum Mengeringhausen" type="Web, Print & Photography" link="external" url="http://www.physiologikum.de/"
                infos="
        ...
        <div className="ck__content__wrapper">
          ...
          <div className="ck__content__wrapper__timestamp">
            <ul className="ck__skill-list">
              <li>
                <TimeStamp time="04/2018" title="Wally" type="Product Design" url=""
                infos="
        ...
        <div className="ck__content__wrapper">
          ...
          <div className="ck__content__wrapper__timestamp">
            <ul className="ck__skill-list">
              ...
              <li>
                <TimeStamp time="10/2016" title="Subform" type="Software & Design" link="external" url="https://subformapp.com/" infos="
